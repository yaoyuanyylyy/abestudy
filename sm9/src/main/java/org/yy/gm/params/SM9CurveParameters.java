...
public class SM9CurveParameters {
    ...
    /** 群的阶N的比特数 */
    public static final int rBits = 256;
    ...
    /** 曲线的标识符。0x12表示Fq上常曲线及其扭曲线 */
    private static final byte cid = 0x12;

    /** 椭圆曲线阶相对于N的余因字: cf * N = #E(Fq) */
    private static final int cf = 1;

    /** 曲线E(Fq)相对于N的嵌入次数。k的因子 d1=1, d2=2。 */
    private static final int k = 12;

    /** 双线性对e的标识符。0x04表示R-Ate对 */
    private static final int eid = 0x04;
