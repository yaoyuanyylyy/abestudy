...
public class SM9KeyExchangeTest {
    ...
    public SM9EncryptMasterKeyPair init(SM9KeyExchangeInitParameters keyExchangeInitParameters) {
        ...
        SM9LogUtils.showMsg("R");
        SM9LogUtils.showMsg(SM9LogUtils.toHexString(R.toBytes()));
    ...
    public SM9KeyAgreement calculateKey(SM9KeyExchangeParameters params) throws CryptoException {
        ...
        SM9LogUtils.showMsg("g1:");
        SM9LogUtils.showMsg(SM9LogUtils.toHexString(SM9Utils.GTFiniteElementToByte(g1)));
        SM9LogUtils.showMsg("g2:");
        SM9LogUtils.showMsg(SM9LogUtils.toHexString(SM9Utils.GTFiniteElementToByte(g2)));
        SM9LogUtils.showMsg("g3:");
        SM9LogUtils.showMsg(SM9LogUtils.toHexString(SM9Utils.GTFiniteElementToByte(g3)));
