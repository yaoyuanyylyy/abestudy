 ...
 */
public class SM9KEMEngine extends PairingKeyEncapsulationMechanism {
    @Override
    ...
    protected SM9KeyPackage keyEncapsulate() {
        ...
        Element QB = SM9Utils.preQ(kemParameters.publicKey, kemParameters.hid, kemParameters.id);
    ...
    protected byte[] keyDecapsulate(byte[] in, int inOff, int inLen) throws InvalidCipherTextException {
        ...
        Element w = pairing.pairing(C, kdmParameters.secretKey.d);
